...
const backgrounds = {
    ...
    comic_store: \`
        ...
        <div class="absolute top-[30%] left-[10%] right-[10%] bottom-[20%] flex gap-4">
            <div class="flex-1 bg-gray-800 border-4 border-gray-600 shadow-inner"></div>
            <div class="flex-1 bg-gray-800 border-4 border-gray-600 shadow-inner"></div>
            <div class="flex-1 bg-gray-800 border-4 border-gray-600 shadow-inner"></div>
        </div>
...
fs.appendFileSync('vectors.js', bg);
console.log('Done');
