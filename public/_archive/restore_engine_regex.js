...
const regex = /function startAutomationEngines\(\) \{[\s\S]*?(?=function triggerUniqueVisuals)/;

const newBlock = `function startAutomationEngines() {
...
console.log("Restored startAutomationEngines successfully via regex");
